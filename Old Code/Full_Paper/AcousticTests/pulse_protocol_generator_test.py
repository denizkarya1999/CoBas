...
# --- Alignment structure ---
initial_silence_sec = 3.0
beacon_freq           = 10000     # Hz (outside chirp band)
beacon_duration_sec   = 2.0
guard_silence_sec    = 2.0 # DO NOT TOUCH
tail_silence_sec     = 2.0 # DO NOT TOUCH
...
active_secs    = pulse_duration + gap_duration
cycles_total   = 30

path = "/Users/pedropaiva/Dev/Research/CoBasE-Energy/cobasFork/Full_Paper/AcousticTests/"
output_file = path + f"{cycles_total}_test.wav"
