...
def segment_video(input_video_path, output_folder, cut_seconds=CUT_SECONDS):
...
def main():
    ...
    parser.add_argument("--cut-seconds", type=int, default=CUT_SECONDS)
    args = parser.parse_args()

    if not segment_video(args.input_video, args.output_folder, args.cut_seconds):
        raise SystemExit(1)
